    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model <Namespace>\<Module>Model\<Module> */
        ...
        $form->setHtmlIdPrefix('<module>_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_<module>_edit_tab_content_prepare_form', ['form' => $form]);
